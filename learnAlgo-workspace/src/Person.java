...
class Test {
	...
	System.out.println("Is BST<Person> Balanced = "+b.isBalanced());
	System.out.println("isBST(b) = "+b.isBST());
	System.out.println("getPredecessor of b (answer should be a) = "+b.getPredecessor(p2).name);
	System.out.println("getPredecessor of l (answer should be k) = "+b.getPredecessor(p12).name);
